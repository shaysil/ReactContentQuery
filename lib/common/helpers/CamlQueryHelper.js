...
var CamlQueryHelper = (function () {
    ...
    CamlQueryHelper.generateCamlQuery = function (querySettings) {
        ...
        if (querySettings.filters && !sp_lodash_subset_1.isEmpty(querySettings.filters)) {
        ...
        if (querySettings.orderBy && !sp_lodash_subset_1.isEmpty(querySettings.orderBy)) {
        ...
        if (querySettings.viewFields && !sp_lodash_subset_1.isEmpty(querySettings.viewFields)) {
    ...
    CamlQueryHelper.generateTaxonomyFilter = function (filter) {
        ...
        if (sp_lodash_subset_1.isEmpty(filter.value)) {
            return '';
        }
    ...
    CamlQueryHelper.generateUserFilter = function (filter) {
        ...
        else if (sp_lodash_subset_1.isEmpty(filter.value)) {
            return '';
        }
    ...
    CamlQueryHelper.formatFilterValue = function (filter) {
        var filterValue = "";
        if (filter.field.type == QueryFilterFieldType_1.QueryFilterFieldType.Datetime) {
            if (filter.expression != null && !sp_lodash_subset_1.isEmpty(filter.expression)) {
